...
pub const TEST_CASES: &[(&[u8], &str)] = &[
    ...
    (
        &[5, 161, 183, 125, 169, 204, 146, 105, 72, 119, 51, 229, 12, 82, 129, 164, 76, 56, 134, 103, 160, 97, 213, 60, 81, 141, 202, 192],
        "9vT0JOBMQFT6iqwdZGlxD5r12g1GmBkpyO7Ru",
    ),
    (
        &[0, 233, 139, 142, 34, 240, 62, 98, 229, 37, 31, 193, 112, 196, 207, 142, 12, 241, 252, 25, 86, 33, 194, 162, 87, 148, 84, 185, 228, 87, 19, 230, 29],
        "0SHkNEQ2yDaqlBpmnQ2HSl151NViW2cfqsFfBGEIGp0f",
    ),
    (
